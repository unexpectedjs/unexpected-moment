...
describe('unexpected-moment', function () {
  ...
  describe('to be a moment', function () {
    ...
    it('throws the correct error if the subject is not a moment instance', function () {
      expect(
        ...
        'to error with',
        "expected 'not moment' to be a moment"
      );
    });
  });
  ...
  describe('not to be a moment', function () {
    ...
    it('throws the correct error if the subject is a moment instance', function () {
      expect(
        ...
        'to error with',
        "expected moment('2016-01-01T00:00:00.000+01:00') not to be a moment"
      );
    });
  });
  ...
  describe('to satisfy', function () {
    ...
    it('throws for utc moments if passed a value that has no timezone information', function () {
      expect(function () {
        expect(moment.utc('2015-01-01T00:00:00+00:00'), 'to satisfy', [
          2015,
          0,
          1,
          0,
      ...
      expect(function () {
        expect(
          moment.utc('2015-01-01T00:00:00+00:00'),
          'to satisfy',
          '2015-01-01T00:00:00'
        );
      }, 'to error');
    ...
    it('throws the correct error if the assertion fails for an empty array value', function () {
      expect(
        ...
        'to error with',
        "expected moment('2016-01-01T00:00:00.000+01:00') " + 'to satisfy []'
      );
    });
    ...
    it('throws the correct error if the assertion fails for a Date value', function () {
      expect(
        function () {
          expect(
            moment.utc('2016-01-01').utcOffset(1),
            'to satisfy',
            new Date('2016-01-02T00:00:00Z')
          );
        },
        'to error with',
      ...
      expect(
        function () {
          expect(
            moment.utc('2016-01-01').utcOffset(1),
            'to satisfy',
            new Date('Fri Jan 01 2016 00:00:00.010 GMT+0100 (CET)')
          );
        },
        'to error with',
        "expected moment('2016-01-01T01:00:00.000+01:00')\n" +
    ...
    it('does not include the diff if the outputs are equal for an array value', function () {
      expect(
        function () {
          expect(moment.utc('2016-01-01T00:00:00+00:00'), 'to satisfy', [
            2016,
            0,
            1,
            0,
    ...
    it('does not include the diff if the outputs are equal for a Date value', function () {
      expect(
        function () {
          expect(
            moment.utc('2016-01-01T00:00:00+00:00'),
            'to satisfy',
  ...
  describe('not to be after', function () {
    ...
    it('throws the correct error if the assertion fails', function () {
      expect(
        function () {
          expect(moment('2016-01-02'), 'not to be after', {
            year: 2016,
            month: 0,
            day: 1,
            hour: 0,
      ...
      expect(
        function () {
          expect(
            ...
            1451689200000
          ); // 1451689200000 -> new Date('2016-01-02 00:00:00')
        },
        'to error with',
        "expected moment('2016-01-01T00:00:00.000+01:00')\n" +
  ...
  describe('when formatted with', function () {
    ...
    it('returns the formatted moment as the fulfilment value if an assertion is not provided', function () {
      expect(moment(0), 'when formatted with', 'YYYYMMDD').then(function (
        formatted
      ) {
  ...
  describe('not to be the start of', function () {
    it('passes if the passed moment is not start of the unit of time provided', function () {
      expect(
        moment('2016-01-01 00:00:01.002+01:00'),
        'not to be the start of second'
      );
    });
  ...
  describe('to be the end of', function () {
    it('end of second', function () {
      expect(
        moment('2016-01-01 00:00:01.999+01:00'),
        'to be the end of second'
      );
    });

    it('end of minute', function () {
      expect(
        moment('2016-01-01 00:01:59.999+01:00'),
        'to be the end of minute'
      );
    });
    ...
    it('end of isoWeek', function () {
      expect(
        moment('2016-01-10 23:59:59.999+01:00'),
        'to be the end of isoWeek'
      );
    });
    ...
    it('end of quarter', function () {
      expect(
        moment('2016-03-31 23:59:59.999+02:00'),
        'to be the end of quarter'
      );
    });
  ...
  describe('not to be the end of', function () {
    ...
    it('throws the correct error if the assertion fails', function () {
      expect(
        function () {
          expect(
            moment('2016-01-02T23:59:59.999+01:00'),
